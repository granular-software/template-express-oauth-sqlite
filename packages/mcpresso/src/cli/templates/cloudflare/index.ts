...
export const cloudflareTemplate: Template = {
  id: 'cloudflare',
  name: 'Cloudflare Workers',
  description: 'Global edge computing platform',
  category: 'cloud',
  features: ['Sub-10ms cold starts', 'Global edge network', 'Built-in DDoS protection'],
  complexity: 'easy',
  ...
  generateFiles: async (config: ProjectConfig) => {
    ...
    // Wrangler config
    files['wrangler.toml'] = `name = "${config.name}"
main = "src/server.ts"
...
const app = createMCPServer({
  name: "${config.name}",
  serverUrl: process.env.SERVER_URL || "https://your-worker.your-subdomain.workers.dev",
  ...
  serverMetadata: {
    ...
    url: process.env.SERVER_URL || "https://your-worker.your-subdomain.workers.dev",
    license: {
      name: "MIT",
...
# These will be set automatically by Cloudflare
# SERVER_URL=https://your-worker.your-subdomain.workers.dev
`;
...
export const oauthConfig = {
  oauthServer: new MCPOAuthServer({
    issuer: process.env.OAUTH_ISSUER || "https://your-worker.your-subdomain.workers.dev",
    serverUrl: process.env.SERVER_URL || "https://your-worker.your-subdomain.workers.dev",
