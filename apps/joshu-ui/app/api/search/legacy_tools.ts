...
//         maxResults: z.array(z.number().describe('Array of maximum number of results to return per query. Default is 10.').default(10)),
//         topics: z.array(
//             z
...
//             const detailsResponse = await fetch(`${TMDB_BASE_URL}/${firstResult.media_type}/${firstResult.id}?language=en-US`, {
//                 headers: {
//                     Authorization: `Bearer ${TMDB_API_KEY}`,
//                     accept: 'application/json',
//                 },
...
//             const creditsResponse = await fetch(`${TMDB_BASE_URL}/${firstResult.media_type}/${firstResult.id}/credits?language=en-US`, {
//                 headers: {
//                     Authorization: `Bearer ${TMDB_API_KEY}`,
//                     accept: 'application/json',
//                 },
...
//                 const distance = Math.sqrt(Math.pow(placeLng - centerLng, 2) + Math.pow(placeLat - centerLat, 2));
