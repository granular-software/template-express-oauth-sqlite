                ...
                <div className="relative pt-20 pb-20 px-4">
                    ...
                    >
                        ...
                        <motion.div variants={item} className="text-center">
                            <Link
                                href="/"
                                className="inline-flex items-end gap-3 text-5xl font-lora font-bold"
                                >
                                <NextImage src="/scira.png" alt="Scira Logo" className="h-16 w-16 invert-0" width={64} height={64} unoptimized quality={100}/>
